import {
  ...
  function getBuddyListFriends(list: BuddyList): Friend[] {
    return list.members.reduce((friendsList, buddy) => {
      if ("phone" in buddy) { // Check if the buddy is of type Friend
        friendsList.push(buddy as Friend);
      }
      return friendsList;
    }, [] as Friend[]);
  }
